  ...
  Widget build(BuildContext context) {
    return ConstrainedBox(
      ...
      child: Stack(
        ...
        children: [
          if (_showWaves) ...[
            Blob(color: MyColors.myBlue, scale: _scale, rotation: _rotation),
            Blob(color: MyColors.myNavyBlue, scale: _scale, rotation: _rotation * 2 - 30),
            Blob(color: MyColors.myGrey, scale: _scale, rotation: _rotation * 3 - 45),
          ],
          Container(
